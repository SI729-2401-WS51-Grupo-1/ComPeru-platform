package pe.edu.upc.comperu_platform.profiles.interfaces.rest;
...
import pe.edu.upc.comperu_platform.profiles.domain.services.ProfileCommandService;
...
import pe.edu.upc.comperu_platform.profiles.interfaces.rest.transform.CreateProfileCommandFromResourceAssembler;
import pe.edu.upc.comperu_platform.profiles.interfaces.rest.transform.ProfileResourceFromEntityAssembler;
...
public class ProfilesController {
  ...
  public ResponseEntity<ProfileResource> getProfileById(@PathVariable Long profileId) {
    ...
    if (profile.isEmpty())
      return ResponseEntity.badRequest().build();
    var profileResource = ProfileResourceFromEntityAssembler.toResourceFromEntity(profile.get());
    return ResponseEntity.ok((ProfileResource) profileResource);
  }
  ...
  public ResponseEntity<List<Object>> getAllProfiles() {
    ...
    return ResponseEntity.ok(Collections.singletonList(profileResources));
  }
}